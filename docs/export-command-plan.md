...
# テーブルフィルタ（任意）
noco-meta export --table "Posts,Authors"
  ...
  "tables": [
    {
      "title": "Posts",
      "fields": [
        { "title": "Title", "type": "SingleLineText", "required": true },
        { "title": "パターン", "type": "SingleSelect", "options": { "choices": [...] } },
        { "title": "RelatedPost", "type": "LinkToAnotherRecord", "options": { "relationType": "hm", "relatedTable": "Categories" } }
      ],
      "views": [
